...
async def upload_background(room_id: str, user_name: str, file: UploadFile = File(...)):
    ...
    await game_service.add_player_background(room_id, user_name, file_exposed_location)
